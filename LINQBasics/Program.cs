...
var itemList = new List<Item>
{
    ...
    new Item{ Id = Guid.NewGuid(), Name = "Product#1", Price = 2, Quantity = 0},
...
Console.WriteLine(itemList.FirstOrDefault());
Console.WriteLine(itemList.FirstOrDefault(i => i.Name.Contains("Product#1")));
Console.WriteLine(itemList.SingleOrDefault(i => i.Name.Contains("Product#2")));
Console.WriteLine(itemList.Any(i => i.Name == "Product#2"));
var selectedValues = itemList.Where(i => i.Price >= 100M).Select(i => new { i.Price, i.Name });
Console.WriteLine();